                ...
                <article className="exotic">
...

                    {
                        ...
                        ? (<div className="controls">
                            <Link className="edit" to={`/destination/edit/${this.state.id}`} >Edit</Link>
                            <Link className="delete" to="/" onClick={() => this.props.deleteDestination(this.state.id)} >Delete</Link>
                            </div>)
                        : (<div className="controls">
                            {
                                isDisabled
                                ? <Link className="info" to="/">Already in your wish list</Link>
                                : <Link className="visit" to="/" onClick={() => this.props.visitDestination(this.state.id)} >Want to visit</Link>
                            }
                        </div>)
                    }
